...
export default function XRay() {
  ...
  const ExamCard = ({ exam, patient }: { exam: XrayExam; patient?: Patient | null }) => {
    ...
    const handleExamCardKeyDown = (e: React.KeyboardEvent) => {
    ...
    return (
      <div
        ...
        onKeyDown={handleExamCardKeyDown}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="relative">
              ...
              <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-indigo-600 to-blue-700 
            ...
            <div>
              <h1 className="text-3xl font-bold bg-gradient-to-r from-indigo-700 to-blue-600 
                           bg-clip-text text-transparent dark:from-indigo-400 dark:to-blue-300">
                X-Ray Department
              </h1>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    aria-label="Show information about X-ray order creation"
                  >
                ...
                <TooltipContent side="bottom" align="end" className="max-w-md p-3">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm">
                      New X-ray orders can only be created from the <strong>Treatment page</strong> by doctors during patient visits. 
