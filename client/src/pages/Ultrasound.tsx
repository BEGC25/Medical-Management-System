              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <button
                    ...
                    aria-label="Show information about ultrasound order creation"
                  >
                ...
                <TooltipContent side="bottom" align="end" className="max-w-md p-3">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm">
                      New ultrasound orders can only be created from the <strong>Treatment page</strong> by doctors during patient visits. 
