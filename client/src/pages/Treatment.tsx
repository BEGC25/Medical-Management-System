                ...
                {orders.some(o => o.status === 'completed' && !o.addToCart && o.isPaid) && (
                  <Button
                    ...
                    onClick={() => {
                      ...
                      Promise.all(
                        completedOrders.map(order => addToCartMutation.mutate({ orderLineId: order.orderLine?.id ?? order.orderId, addToCart: true }))
                      );
                    }}
                            ...
                            <div className="flex flex-col gap-2">
                              {test.status === 'completed' && test.orderLine && (
                                <>
                                  <div className="flex items-center gap-2">
                                    <Checkbox
                                      id={`ack-lab-${test.orderLine?.id ?? test.orderId ?? test.testId ?? "na"}`}
                                      ...
                                      data-testid={`ack-lab-${test.orderLine?.id ?? test.orderId ?? test.testId ?? "na"}`}
                                    />
                                  ...
                                  {test.orderLine.acknowledgedBy && !test.orderLine.addToCart && (
                                    <Button 
                                      ...
                                      data-testid={`add-cart-lab-${test.orderLine?.id ?? test.orderId ?? test.testId ?? "na"}`}
                                    >
                              ...
                              {test.status === 'completed' && (
                                <Button 
                                  ...
                                  data-testid={`view-lab-${test.orderLine?.id ?? test.orderId ?? test.testId ?? "na"}`}
                                >
                                  View Results
                                </Button>
                              )}
                            ...
                            <div className="flex flex-col gap-2">
                              {xray.status === 'completed' && xray.orderLine && (
                                <>
                                  <div className="flex items-center gap-2">
                                    <Checkbox
                                      id={`ack-xray-${xray.orderLine?.id ?? xray.orderId ?? xray.examId ?? "na"}`}
                                      ...
                                      data-testid={`ack-xray-${xray.orderLine?.id ?? xray.orderId ?? xray.examId ?? "na"}`}
                                    />
                                  ...
                                  {xray.orderLine.acknowledgedBy && !xray.orderLine.addToCart && (
                                    <Button 
                                      ...
                                      data-testid={`add-cart-xray-${xray.orderLine?.id ?? xray.orderId ?? xray.examId ?? "na"}`}
                                    >
                                      <Plus className="h-3 w-3 mr-1" />
                                      Add to Summary
                                    </Button>
                              ...
                              {xray.status === 'completed' && (
                                <Button 
                                  ...
                                  data-testid={`view-xray-${xray.orderLine?.id ?? xray.orderId ?? xray.examId ?? "na"}`}
                                >
                                  View Report
                                </Button>
                              )}
                            ...
                            <div className="flex flex-col gap-2">
                              {ultrasound.status === 'completed' && ultrasound.orderLine && (
                                <>
                                  <div className="flex items-center gap-2">
                                    <Checkbox
                                      id={`ack-ultrasound-${ultrasound.orderLine?.id ?? ultrasound.orderId ?? ultrasound.examId ?? "na"}`}
                                      ...
                                      data-testid={`ack-ultrasound-${ultrasound.orderLine?.id ?? ultrasound.orderId ?? ultrasound.examId ?? "na"}`}
                                    />
                                  ...
                                  {ultrasound.orderLine.acknowledgedBy && !ultrasound.orderLine.addToCart && (
                                    <Button 
                                      ...
                                      data-testid={`add-cart-ultrasound-${ultrasound.orderLine?.id ?? ultrasound.orderId ?? ultrasound.examId ?? "na"}`}
                                    >
                                      <Plus className="h-3 w-3 mr-1" />
                                      Add to Summary
                                    </Button>
                              ...
                              {ultrasound.status === 'completed' && (
                                <Button 
                                  ...
                                  data-testid={`view-ultrasound-${ultrasound.orderLine?.id ?? ultrasound.orderId ?? ultrasound.examId ?? "na"}`}
                                >
                                  View Report
                                </Button>
                              )}
...
<Button
  ...
  variant="secondary"
  data-testid="btn-generate-prescription"
>
