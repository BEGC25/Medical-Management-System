  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="print:hidden">
        ...
        {/* Start of 2-column layout for main content */}
        {selectedPatient && currentEncounter && (
            ...
            <CardContent className="p-6">
              ...
              >
                ...
                <div className="mt-auto pt-8 border-t">
                  ...
                  <p className="text-xs text-gray-500 mt-4 text-center">Aweil, South Sudan | www.bahrelghazal.com | info@bahrelghazal.com</p>
                </div>
              </div>
