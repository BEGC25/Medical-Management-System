    ...
    return (
      <div
        className={cx(
          ...
          !isCompleted && !isPaid && "bg-red-50/50 dark:bg-red-900/10 border-red-500",
      ...
      >
        <div className="flex justify-between items-start gap-3">
          ...
          <div className="shrink-0 flex items-center gap-2">
            ...
            {canPerform && <ChevronRight className="w-4 h-4 text-gray-400 group-hover:text-cyan-500 group-hover:translate-x-0.5 transition-all duration-200" />}
          </div>
        </div>
      </div>
    );
            ...
            <div className="space-y-2">
              {completedExams.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-8 text-center">
                  ...
                  <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">No completed X-ray examinations</h3>
