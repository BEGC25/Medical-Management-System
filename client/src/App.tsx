...
import OrderReferralDiagnostic from "@/pages/OrderReferralDiagnostic";
...
function AppLayout() {
  ...
  return (
    <>
      ...
      <main className="min-h-screen ml-0 lg:ml-64 pt-12 transition-all duration-300">
        <div className="px-3 sm:px-4 md:px-6 py-2 sm:py-3 md:py-4">
          <Switch>
            ...
            {/* Settings - Admin Only */}
            <ProtectedRoute path="/order-referral" component={OrderReferralDiagnostic} allowedRoles={[ROLES.ADMIN]} />
...
function App() {
  return (
    <QueryClientProvider client={queryClient}>
      <AuthProvider>
        <div className="min-h-screen bg-[hsl(var(--surface-50))]">
          <DebugTimeBanner />
          <OfflineIndicator />
