...
- August 14, 2025. Standardized all print headers for consistency: Laboratory, X-ray, and treatment documents now use identical professional headers with clinic branding. Fixed print modals to show clean document previews instead of UI components. All printing modules now produce single-page documents with consistent formatting
