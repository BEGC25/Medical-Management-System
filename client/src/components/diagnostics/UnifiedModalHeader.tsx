...
export function UnifiedModalHeader({
  ...
  return (
    <div className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 px-6 py-4 -mx-6 -mt-6 mb-4 rounded-t-xl">
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          {patient && (
            <div className="flex items-center gap-2 text-sm bg-white dark:bg-gray-800 rounded-md px-3 py-1.5 border border-gray-200 dark:border-gray-600 shadow-sm">
              ...
              <span className="text-gray-400">•</span>
              <span className="font-mono text-xs text-gray-500 dark:text-gray-400">{patient.patientId}</span>
            </div>
          )}
